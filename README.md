...
* Ensure **connections are checked** before switching on the kit.
* Verify all **connections are done properly** and securely.
* Take **observations accurately and systematically**.
**Precautions:**
